...
export const generateDuplicationDetectionId = ({
  ...
  /**
   * Hypothesis - If a company is small, there will be unique names even if there are not URLs to each job postings.
   *    If a company is large, there will be URLs per job posting.
   *    This algorithm could definitely be improved. For example, if a company posts a "Software Engineer" job today,
